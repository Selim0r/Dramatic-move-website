...
function Footer() {
  return (
    <footer className="footer sm:footer-horizontal bg-gray-900  text-white p-10">
      <div className="">
        <p className="font-bold font-griffy text-yellow-400 text-3xl">
          DRAMATIC
        </p>
        <p className="text-lg text-gray-500 font-mon">Enjoy Your Movie Time</p>
      </div>
      <nav>
        <h6 className="footer-title">Navigation</h6>
        <a className="link link-hover">Home</a>
        <a className="link link-hover">TvShow</a>
      ...
      <nav>
        ...
        <a className="link link-hover">Cookie Preference</a>
        <a className="link link-hover">Corporate Information</a>
      </nav>
      <nav>
        <h6 className="footer-title">Talks to Us</h6>
